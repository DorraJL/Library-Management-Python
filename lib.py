...
class menu:
    ...
    def __init__(self):
        ...
        l1 = Button(self.a, text='BOOK', font='Georgia 22 bold', fg='Yellow', bg='Black', width=19, padx=10,
                    borderwidth=0, command=self.book).place(x=900, y=200)
        l2 = Button(self.a, text='STUDENTS', font='Georgia 22 bold', fg='Yellow', bg='Black', width=19, padx=10,
                    borderwidth=0, command=self.student).place(x=900, y=400)
        self.root.mainloop()
    ...
    def book(self):
        ...
        l1 = Button(self.a, text='Add Books', font='Georgia 22 bold', fg='Orange', bg='Black', width=15, padx=10,
                    command=self.addbook).place(x=12, y=100)
        l2 = Button(self.a, text='Search Books', font='Georgia 22 bold', fg='Orange', bg='Black', width=15, padx=10,
                    command=self.search).place(x=12, y=200)

        l4 = Button(self.a, text='Show List Book', font='Georgia 22 bold', fg='Orange', bg='Black', width=15, padx=10,
                    command=self.all).place(x=12, y=300)
        l4 = Button(self.a, text='Back', font='Georgia 22 bold', fg='Orange', bg='Black', width=15, padx=10,
    ...
    def addbook(self):
        ...
        l1 = Label(self.f1, text='Book ID : ', font='Georgia 12 bold', fg='Orange', bg='Black', pady=1).place(x=50,
                                                                                                              y=50)
        e1 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aid).place(x=150, y=50)
        l2 = Label(self.f1, text='Title : ', font='Georgia 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=100)
        e2 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aname).place(x=150, y=100)
        l3 = Label(self.f1, text='Author : ', font='Georgia 12 bold', fg='orange', bg='Black', pady=1).place(x=50,
                                                                                                             y=150)
        e3 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aauthor).place(x=150, y=150)
        l4 = Label(self.f1, text='Genre : ', font='Georgia 12 bold', fg='orange', bg='Black', pady=1).place(x=50, y=200)
        e2 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.agenre).place(x=150, y=200)
        l4 = Label(self.f1, text='Copies : ', font='Georgia 12 bold', fg='orange', bg='Black', pady=1).place(x=50,
                                                                                                             y=250)
        e2 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.acopies).place(x=150, y=250)
        l5 = Label(self.f1, text='Location : ', font='Georgia 12 bold', fg='orange', bg='Black', pady=1).place(x=50,
                                                                                                               y=300)
        e3 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aloc).place(x=150, y=300)
        self.f1.grid_propagate(0)
        b1 = Button(self.f1, text='Add', font='Georgia 10 bold', fg='black', bg='orange', width=15, bd=3,
                    command=self.adddata).place(x=150, y=400)
        b2 = Button(self.f1, text='Back', font='Georgia 10 bold', fg='black', bg='orange', width=15, bd=3,
    ...
    def search(self):
        ...
        self.f1 = Frame(self.a, height=500, width=650, bg='black')
        self.f1.place(x=500, y=100)
        l1 = Label(self.f1, text='Book ID/Title/Author/Genre: ', font=('Georgia 10 bold'), bd=2, fg='orange',
                   bg='black').place(x=20, y=40)
        e1 = Entry(self.f1, width=25, bd=5, bg='orange', fg='black', textvariable=self.sid).place(x=260, y=40)
        b1 = Button(self.f1, text='Search', bg='orange', font='Georgia 10 bold', width=9, bd=2,
                    command=self.serch1).place(x=500, y=37)
        b1 = Button(self.f1, text='Back', bg='orange', font='Georgia 10 bold', width=10, bd=2, command=self.rm).place(
            x=250, y=450)
    ...
    def deleteitem(self):
        try:
            ...
            b1 = Button(self.f1, text='Update', font='Georgia 10 bold', width=9, bd=3, command=self.delete2).place(
                x=500, y=97)
    ...
    def copies(self, varr):
        try:
            ...
            if varr == 0:
                b5 = Button(self.f1, text='Update', font='Georgia 10 bold', bg='orange', fg='black', width=9, bd=3,
                            command=self.copiesadd).place(x=500, y=97)
            if varr == 1:
                b6 = Button(self.f1, text='Update', font='Georgia 10 bold', bg='orange', fg='black', width=9, bd=3,
    ...
    def student(self):
        self.a.destroy()
        self.a = self.canvases(image2)
        l1 = Button(self.a, text='Borrow book', font='Georgia 22 bold', fg='Orange', bg='Black', width=15, padx=10,
                    command=self.issue).place(x=12, y=100)
        l2 = Button(self.a, text='Return Book', font='Georgia 22 bold', fg='Orange', bg='Black', width=15, padx=10,
                    command=self.returnn).place(x=12, y=200)
        l3 = Button(self.a, text='Show List Students', font='Georgia 22 bold', fg='Orange', bg='Black', width=15,
                    padx=10, command=self.activity).place(x=12, y=300)
        l4 = Button(self.a, text='Back', font='Georgia 22 bold', fg='Orange', bg='Black', width=15, padx=10,
    ...
    def issue(self):
        ...
        self.f1.place(x=500, y=100)
        l1 = Label(self.f1, text='Book ID : ', font='Georgia 15 bold', bg='black', fg='orange').place(x=50, y=100)
        e1 = Entry(self.f1, width=25, bd=4, bg='orange', textvariable=self.aidd).place(x=180, y=100)
        l2 = Label(self.f1, text='Student Id : ', font='Georgia 15 bold', bg='black', fg='orange').place(x=50, y=150)
        e2 = Entry(self.f1, width=25, bd=4, bg='orange', textvariable=self.astudentt).place(x=180, y=150)
        b1 = Button(self.f1, text='Back', font='Georgia 10 bold', fg='black', bg='orange', width=10, bd=3,
                    command=self.rm).place(x=50, y=250)
        b1 = Button(self.f1, text='Borrow', font='Georgia 10 bold', fg='black', bg='orange', width=10, bd=3,
    ...
    def returnn(self):
        ...
        self.f1 = Frame(self.a, height=550, width=500, bg='black')
        self.f1.place(x=500, y=100)
        l1 = Label(self.f1, text='Book ID : ', font='Georgia 15 bold', fg='orange', bg='black').place(x=50, y=100)
        e1 = Entry(self.f1, width=25, bd=4, bg='orange', textvariable=self.aidd).place(x=180, y=100)
        l2 = Label(self.f1, text='Student Id : ', font='Georgia 15 bold', fg='orange', bg='black').place(x=50, y=150)
        e2 = Entry(self.f1, width=25, bd=4, bg='orange', textvariable=self.astudentt).place(x=180, y=150)
        b1 = Button(self.f1, text='Back', font='Georgia 10 bold', bg='orange', fg='black', width=10, bd=3,
                    command=self.rm).place(x=50, y=250)
        b1 = Button(self.f1, text='Return', font='Georgia 10 bold', bg='orange', fg='black', width=10, bd=3,
    ...
    def activity(self):
        ...
        l1 = Label(self.f1, text='Book/Student ID : ', font='Georgia 15 bold', fg='Orange', bg='black').place(x=50,
                                                                                                              y=30)
        ...
        b1 = Button(self.f1, text='Back', bg='orange', font='Georgia 10 bold', width=10, bd=3, command=self.rm).place(
            x=340, y=450)
        b1 = Button(self.f1, text='Search', bg='orange', font='Georgia 10 bold', width=10, bd=3,
                    command=self.searchact).place(x=40, y=450)
        b1 = Button(self.f1, text='All', bg='orange', font='Georgia 10 bold', width=10, bd=3,
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('Dorra', 'root')")
        conn.commit()
...
# ==============================LABELS=========================================
lbl_title = Label(canvas, text="ADMIN   LOGIN", font=('Georgia', 30, 'bold',), bg='black', fg='orange')
lbl_title.place(x=900, y=100)
lbl_username = Label(canvas, text="Username:", font=('Georgia', 15, 'bold'), bd=4, bg='black', fg='orange')
lbl_username.place(x=900, y=230)
lbl_password = Label(canvas, text="Password :", font=('Georgia', 15, 'bold'), bd=3, bg='black', fg='orange')
lbl_password.place(x=900, y=330)
...
username.place(x=1040, y=230, )
password = Entry(canvas, textvariable=PASSWORD, show="*", font=(14), bg='black', fg='orange', bd=6)
password.place(x=1040, y=330)

# ==============================BUTTON WIDGETS=================================
btn_login = Button(canvas, text="LOGIN", font=('Georgia 15 bold'), width=25, command=Login, bg='black', fg='orange')
btn_login.place(x=900, y=400)
